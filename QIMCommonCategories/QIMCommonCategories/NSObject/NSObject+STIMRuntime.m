...
@implementation NSObject (STIMRuntime)
...
- (void)stimDB_setNilValueForKey:(NSString *)key {
    return;
}
...
- (void)stimDB_setValue:(id)value forUndefinedKey:(NSString *)key {
