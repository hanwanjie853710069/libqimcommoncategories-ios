...
*/
+ (UIImage * _Nullable)stimDB_animatedImageWithAnimatedGIFData:(NSData * _Nonnull)theData;
...
*/
+ (UIImage * _Nullable)stimDB_animatedImageWithAnimatedGIFURL:(NSURL * _Nonnull)theURL;
